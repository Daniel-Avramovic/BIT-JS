var nodeBackgroun = document.getElementById('bodyMove');
var background = document.getElementById('bodyMove');
var mario = document.getElementById('bodyMove').lastElementChild;
console.log(mario);

function change(){
    mario.src = 'img/mario_running.gif';
    background.style.backgroundPositionX = (40 - setInterval(function () { var num = 1; num++; return num }, 1)) + "vh";
}
function move(){
    
}
nodeBackgroun.addEventListener('mousedown', change);
...
// document.addEventListener("contextmenu", getMarioToRun);     // if we comment this we need to uncomment code UP var bodyNode = document.querySelector("body");
// var
